...
public interface BodyFatCalculator {
    ...
    @RequestWrapper(localName = "generateBodyFatReport", targetNamespace = "http://fitness.org/", className = "com.fitness.GenerateBodyFatReport")
    @ResponseWrapper(localName = "generateBodyFatReportResponse", targetNamespace = "http://fitness.org/", className = "com.fitness.GenerateBodyFatReportResponse")
    ...
    public String generateBodyFatReport(
        ...
        double hip,
        @WebParam(name = "isMetric", targetNamespace = "")
        boolean isMetric);
